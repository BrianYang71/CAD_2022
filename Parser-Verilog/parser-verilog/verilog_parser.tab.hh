...
#line 11 "parser-verilog/verilog_parser.yy" // lalr1.cc:401
...
#line 67 "verilog_parser.tab.hh" // lalr1.cc:401
...
#line 6 "parser-verilog/verilog_parser.yy" // lalr1.cc:401
namespace verilog {
#line 183 "verilog_parser.tab.hh" // lalr1.cc:401
...
switch (yytype)
    ...
    struct symbol_type : basic_symbol<by_type>
    {
      ...
      {
        YYASSERT (tok == token::END || tok == 45 || tok == 43 || tok == 42 || tok == 47 || tok == token::UMINUS || tok == token::NEWLINE || tok == token::UNDEFINED || tok == token::MODULE || tok == token::ENDMODULE || tok == token::INPUT || tok == token::OUTPUT || tok == token::INOUT || tok == token::REG || tok == token::WIRE || tok == token::WAND || tok == token::WOR || tok == token::TRI || tok == token::TRIOR || tok == token::TRIAND || tok == token::SUPPLY0 || tok == token::SUPPLY1 || tok == token::ASSIGN || tok == 59 || tok == 40 || tok == 41 || tok == 44 || tok == 91 || tok == 58 || tok == 93 || tok == 61 || tok == 123 || tok == 125 || tok == 46 || tok == 35 || tok == 96);
      }
#else
      ...
      {
        YYASSERT (tok == token::NAME || tok == token::ESCAPED_NAME);
      }
#else
      ...
      symbol_type (int tok, verilog::Constant v, location_type l)
        : super_type(token_type (tok), std::move (v), std::move (l))
      {
        YYASSERT (tok == token::INTEGER || tok == token::BINARY || tok == token::OCTAL || tok == token::DECIMAL || tok == token::HEX || tok == token::REAL || tok == token::EXP);
      }
#else
...
#line 1728 "verilog_parser.tab.hh" // lalr1.cc:401
